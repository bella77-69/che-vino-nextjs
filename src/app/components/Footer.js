...
const Footer = () => {
  return (
    <footer className="dark:bg-[#000000] text-white ">
      <div className="container mx-auto py-8 px-4 md:px-0 mt-8 border-t pt-4 w-10/12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <ul>
              <li>
                <a href="/wines/reds" className="dark:hover:text-[#CD0617]">
                  Red Wine
                </a>
              </li>
              <li>
                <a href="/wines/whites" className="dark:hover:text-[#CD0617]">
                  White Wine
                </a>
              </li>
              <li>
